...
export default function Checkout() {
  return (
    <div>
      <div className="container wrapper pb-5 mb-5">
        ...
        <div className="row cart-body">
          <form className="form-horizontal row" method="post" action="">
                ...
                <div className="panel-body mt-2">
                  ...
                  <div className="form-group row ">
                    <div className="col-sm-3 col-xs-3">
                      <img
                        className="img-responsive"
                        src="https://c1.staticflickr.com/1/466/19681864394_c332ae87df_t.jpg"
                      />
                    </div>
                    <div className="col-sm-6 col-xs-6">
                      <div className="col-xs-12">Product name</div>
            ...
            <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-md-pull-6 col-sm-pull-6">
              {/* <!--SHIPPING METHOD--> */}
              <div className="panel panel-info">
                <div className="panel-heading p-2">Address</div>
                ...
                <div className="panel-body">
                  ...
                  <div className="form-group">
                    <div className="col-md-6 col-sm-6 col-xs-12">
                      <button
                        type="submit"
                        className="btn btn-primary btn-submit-fix"
                      >
                        Place Order
                      </button>
                    </div>
